                ...
                <div class="row text-center">
                    @foreach ($pictures as $picture)
                        <div class="col-4 " style="height: 400px">
                            ...
                            <form action="{{route('picture.change.album',$picture->id)}}" method="get" class="mt-2 form-move d-none"  id="form-move">
                                <label for="">choose album</label>
                                <select name="album" id="">
                                    <option disabled>choose album</option>
                                    @foreach ($all_albums as $item)
                                        <option @if ($item->id == $picture->album_id) style="color:green" selected
            ...
            <div class="col-8 offset-2">
                ...
                <form method="POST" action="{{ route('pictures.store', $album->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <input type="file" name="images[]" class="form-control" id="inputGroupFile02" multiple="multiple"
